...
.data
	...
	str1: .asciiz "\n Introduza o 1.º número inteiro e positivo na caixa de diálogo. "
	str11: .asciiz "\n Introduza o 1.º número inteiro e positivo. "
	str2: .asciiz "\n Introduza o 2.º número inteiro, positivo e diferente do anterior na caixa de diálogo. "
	str22: .asciiz "\n Introduza o 2.º número inteiro, positivo e diferente do anterior. "
	str3: .asciiz "\n Introduza o 3.º número inteiro, positivo e diferente dos anteriores na caixa de diálogo. "
